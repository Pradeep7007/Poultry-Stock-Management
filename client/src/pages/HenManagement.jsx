              ...
              <div className="modal-body p-4 bg-light">
                <div className="row g-3">
                  <div className="col-12">
                    <div className="card border-0 shadow-sm">
                      <div className="card-body">
                        <h6 className="text-primary fw-bold mb-3 border-bottom pb-2">Timeline</h6>
                        <div className="row g-3">
                          <div className="col-12"><p className="text-muted small fw-semibold mb-1">Batch Name</p><h6 className="fw-bold m-0">{selectedRecord.name}</h6></div>
                          <div className="col-6"><p className="text-muted small fw-semibold mb-1">Start Date</p><h6 className="fw-bold m-0">{formatDate(selectedRecord.startDate)}</h6></div>
                          <div className="col-6"><p className="text-muted small fw-semibold mb-1">End Date</p><h6 className="fw-bold m-0">{formatDate(selectedRecord.endDate)}</h6></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-12">
                    <div className="card border-0 shadow-sm">
                      <div className="card-body">
                        <h6 className="text-success fw-bold mb-3 border-bottom pb-2">Flock Status</h6>
                        <div className="row g-3">
                          <div className="col-6"><p className="text-muted small fw-semibold mb-1">Started Hens</p><h6 className="fw-bold text-primary m-0">{selectedRecord.startedHens?.toLocaleString()}</h6></div>
                          <div className="col-6"><p className="text-muted small fw-semibold mb-1">Alive Hens</p><h6 className="fw-bold text-success m-0">{selectedRecord.aliveHens?.toLocaleString()}</h6></div>
                          <div className="col-6"><p className="text-muted small fw-semibold mb-1">Status</p><h6 className="fw-bold m-0"><span className={`badge-modern badge-${selectedRecord.status === 'Active' ? 'success' : 'secondary'}`}>{selectedRecord.status}</span></h6></div>
                          <div className="col-6"><p className="text-muted small fw-semibold mb-1">Created By</p><h6 className="fw-bold m-0">{selectedRecord.enteredBy || '-'}</h6></div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content border-0 shadow-lg">
              ...
              <div className="modal-body p-4 bg-light">
                <div className="card border-0 shadow-sm">
                  <div className="card-body">
                    <h6 className="text-danger fw-bold mb-3 border-bottom pb-2">Incident Details</h6>
                    <div className="row g-3">
                      ...
                      <div className="col-6"><p className="text-muted small fw-semibold mb-1">Dead Today</p><h6 className="fw-bold text-danger m-0">{selectedRecord.deadToday} Hens</h6></div>
